 ...
 */
public abstract class AbstractMessageCategoryDTO extends DtoSupport
{ 
	...
	public AbstractMessageCategoryDTO()
	{
	}
	public AbstractMessageCategoryDTO(java.lang.String code)
	{
		this.setCode(code);
	}
