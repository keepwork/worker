...
<html>
	...
	<body style="font-size:12px;">
		<div style="text-align: left; background: #f0f0f0; padding: 5px;">
			...
			<a href="${pageContext.request.contextPath}/sys/bmsrscfunc/queryBmsRscFunc.do">返回</a>
		</div>
		...
		<ec:table items="list" var="m" action=""
			...
			<ec:row>
				<ec:column title="名称" property="name" />

				<ec:column title="描述" property="remark" />

				<ec:column title="显示图标" property="icom" />
