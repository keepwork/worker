...
<script src="${pageContext.request.contextPath}/js1.6/jQuery/jquery-1.3.1.js"></script>
...
<!--
	function del()
	{
		...
		{
			hideframe.location.href='${pageContext.request.contextPath}/sys/bmsrscfunc/deleteBmsRscFunc.do';
		}
	}
...
<div class="toolbar">
       	...
       	onClick="MM_goToURL('self','${pageContext.request.contextPath}/sys/bmsrscfunc/beforeAddBmsRscFunc.do');return document.MM_returnValue"><span><span>新增下级功能模块

</span></span></a> 
        <a href="#" class="sexybutton"
        onClick="MM_goToURL('self','${pageContext.request.contextPath}/sys/bmsrscfunc/beforeEditBmsRscFunc.do');return document.MM_returnValue"><span><span>编辑
                       		...
                       		<c:when test="${m.menuFunc==1}">
                       			<tr>
			                        ...
			                        <td width="83%" align="left">
			                        	<c:choose >
			                        		<c:when test="${m.sortid==null}">无</c:when>
			                        		<c:otherwise>${m.sortid} </c:otherwise>
			                        	</c:choose>
			                        </td>
			                      </tr>
                       		</c:when>
