...
<div class="workspace1 left" style="padding:20px;">
				<form name="frmApply"
					action="${pageContext.request.contextPath}/sys/bmsrscfunc/editBmsRscFunc.do"
                ...
                <ol>
                  ...
                  <li class="listyle_4" id="linkaddrDeiv4" style="display:${m.menuFunc=='1'?'block':'none'};">
                    ...
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input name="sortid" id="sortid_" value="${sortid}" type="text" maxlength="30" class="bgw" onkeyup="clearNoNum(this);">
                    </span>
                    </h1>  
                   </li> 
                  ...
                  <li class="listyle_4">
                    ...
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input name="parentid" id="parentid_" value="${m.parentid }" type="text" maxlength="30" class="bgw" >
                    </span></h1>  
                  </li>
                  ...
                  <li class="listyle_4 bordernone">
                     <label class="left pt5">是否菜单：</label>
                        <span>
                        <domain:selectDomain name="menuFunc" uid="menuFunc_"
