...
<div class="left">
</div><div class="barnavtop">您所在的位置：系统管理 > 部门管理 > 新增部门信息</div>
...
<div class="workspace1 left" style="padding-left:20px;">
 <div class="toolbar">
	...
	<div class="editspace">
            <form name="frmApply" class="cmxform" action="${pageContext.request.contextPath}/sys/bmslocation/addLocation.do" 
