...
<script type="text/javascript">
	...
	function delUsers()
	{
		...
		if (confirm('确实要删除？')==true){
			location.href='${pageContext.request.contextPath}/sys/bmslocation/deleteSelectedUser.do?nochks=' + getChecks('ckids',true);
		}
	}	
	function delUser(id){
		var ns = document.getElementsByName("ckids");
...
<div class="workspace left" style="width:100%;">        
        ...
        onClick="location.href='${pageContext.request.contextPath}/sys/bmslocation/addUserForLocation.do?id=${m.id}'"><span><span>新增管理用户</span></span></a>
                </div>
