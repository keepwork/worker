...
<script type="text/javascript">
	function del()
	{
		...
		{
			hideframe.location.href='${pageContext.request.contextPath}/sys/bmslocation/deleteLocation.do';
		}
	}		
		</script>
...
<div class="editspace">
	<form method="post" class="cmxform" target="hideframe">
        ...
        <div class="toolbar mb10">
       	...
       	onClick="MM_goToURL('self','${pageContext.request.contextPath}/sys/bmslocation/beforeEditLocation.do');return document.MM_returnValue">
       	<span><span>编辑</span></span></a> 
        <a class="sexybutton" href="#"
        onClick="MM_goToURL('self','${pageContext.request.contextPath}/sys/bmslocation/beforeAddLocation.do');return document.MM_returnValue">
        <span><span>新增下级部门</span></span></a>
        <a class="sexybutton" onClick="return del();" href="#">
        <span><span>删除</span></span></a>        </div>
        <iframe name="" frameborder="0" height="600px;" width="100%" src="${pageContext.request.contextPath}/sys/bmslocation/listBmsLocationView.do?id=${m.id}"></iframe>
