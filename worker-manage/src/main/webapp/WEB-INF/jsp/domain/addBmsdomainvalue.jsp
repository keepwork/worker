...
<meta name=generator content="MSHTML 8.00.6001.18939">
		...
		function onFormSubmit()
		{
			...
			if(valueType=="TREE" && parentId==""){
				$.ajax({
   					type: "POST",
   					url: "${pageContext.request.contextPath}/sys/bmsdomainvalue/findTree.do",
   					dataType:"html",
        ...
        <!--框内内容 结束-->
           ...
           <h1> <span class="left pt5">字典值定义</span></h1>
            ...
            <form name="formName" method="post" class="cmxform" 
				action="${pageContext.request.contextPath}/sys/bmsdomainvalue/addBmsDomainvalue.do"
                ...
                <ol>
                  <li class="listyle_4">
                    ...
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input id="id_" type="text" name="id" value="<%=new com.common.util.ImitateUUID().getID() %>" readonly="readonly" class="bgw" />
                    </span></h1>
                  <li class="listyle_4">
