...
<script type="text/javascript">
			...
			{
				hideframe.location.href="${pageContext.request.contextPath}/sys/bmsdomainvalue/deleteBmsDomainvalue.do";
			}		
		</script>
...
<div id="workspace">
    ...
    <div id="container">    
        <div class="overf pt5 pb5">
            ...
            <span class="left ml10"><a class="sexybutton" href="#" onclick="location.href='${pageContext.request.contextPath}/sys/bmsdomainvalue/queryBmsDomainvalue.do'"><span><span>返回</span></span></a></span>
        </div>
        <!--searchForm 结束-->
        <!--CmsSiteList 开始-->
