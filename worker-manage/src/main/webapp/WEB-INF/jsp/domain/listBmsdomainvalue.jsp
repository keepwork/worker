...
<meta name=generator content="MSHTML 8.00.6001.18939">
	<script type="text/javascript">
			...
			{
				var url = "${pageContext.request.contextPath}/sys/bmsdomainvalue/beforeDeleteBmsDomainvalue.do";
				if(!$chk(id))
				{
			...
			{
				var url = "${pageContext.request.contextPath}/sys/bmsdomainvalue/beforeAddBmsDomainvalue.do";
        ...
        <div class="eXtremeTable">
			...
			<ec:row>
				...
				<ec:column title="操作" property="EEE" sortable="false"
					filterable="false">
					<a class="sexybutton"
						href="${pageContext.request.contextPath}/sys/bmsdomainvalue/beforeEditBmsDomainvalue.do?id=${m.id}">
