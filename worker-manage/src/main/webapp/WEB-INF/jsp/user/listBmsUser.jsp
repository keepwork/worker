...
<%@page import="com.common.util.consts.BmsConsts"%>
...
<meta name=generator content="MSHTML 8.00.6001.18939">
		<script type="text/javascript">
			...
			{
				var url = "${pageContext.request.contextPath}/sys/bmsuser/beforeDeleteBmsUser.do";
				if(!$chk(id))
				{
			...
			{
				var url = "${pageContext.request.contextPath}/sys/bmsuser/beforeAddBmsUser.do";
			...
			function exportListUser()
			{
				...
				if(!$chk(ids)){
					document.getElementById("BmsUserExList").action= "${pageContext.request.contextPath}/sys/bmsuser/exportListUser.do";
				}else{
					document.getElementById("BmsUserExList").action= "${pageContext.request.contextPath}/sys/bmsuser/exportListUser.do?ids=" + ids;
				}
...
<div id="workspace">
    ...
    <div id="container">    
        <div class="overf pt5 pb5">
            ...
            <span class="right mr10"><a class="sexybutton" href="${pageContext.request.contextPath}/sys/bmsuser/importUserInit.do"><span><span>导入</span></span></a></span>
        </div>
        <!--searchForm 结束-->
        <!--CmsSiteList 开始-->
        <%
        ...
        <div class="eXtremeTable">
			...
			<ec:row>
				...
				<ec:column title="登录名" property="userLoginName" width="12%">
					<a
						href="${pageContext.request.contextPath}/sys/bmsuser/beforeEditBmsUser.do?id=${m.id}">
						${m.userLoginName} </a>
				</ec:column>
				...
				<ec:column title="操作" property="EEE" sortable="false"
					filterable="false">
					<a class="sexybutton" href="${pageContext.request.contextPath}/sys/bmsuser/beforeEditBmsUser.do?id=${m.id}"><span><span>编辑</span></span></a>
					<logic:notEqual value="<%=superman%>" name="m" property="userLoginName">
						...
						<!-- 
						<a class="sexybutton"
							href="javascript:location.href='${pageContext.request.contextPath}/sys/bmsuser/selCanVisitLocation.do?userid=${m.id}';"><span><span>可管理部门</span></span></a>
						 -->
					</logic:notEqual>
				</ec:column>
			</ec:row>
