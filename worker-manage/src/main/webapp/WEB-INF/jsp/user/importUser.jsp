...
<script type="text/javascript">
		function beforeSubmit(){
			...
			//document.form1.action= "${pageContext.request.contextPath}/sys/importUser/importUser.do";
...
<div style="float:left;width:100%;">
    ...
    <div class="toolbar">
       	<a href="${pageContext.request.contextPath}/sys/bmsuser/exportUserInit" class="sexybutton" ><span><span>导出模版</span></span></a> 
    </div>
    <div id="searchForm">
        <form name="form1" style="text-align: left; padding: 10px;" class="cmxform editspace"
			action="${pageContext.request.contextPath}/sys/importUser/importUser.do" target="hideframe"
