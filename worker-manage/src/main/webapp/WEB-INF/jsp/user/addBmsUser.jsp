 ...
 <div class="barnavtop">您所在的位置：系统管理 > 用户管理 > 新增用户</div>
    ...
    <div id="container">
    	<div class="overf pt5 pb5">
         ...
         <!-- input type="reset" value="" style=" background:url(${pageContext.request.contextPath}/sys/images/bao_di.gif); background-repeat:no-repeat; width:48px; height:24px; border:0; color:#666; vertical-align:top"/ -->
    	<!--按钮 开始-->  
        <!--按钮 结束-->  
        <!--框内内容 开始-->
          <div class="editspace">
            <form name="frmApply" class="cmxform"
							action="${pageContext.request.contextPath}/sys/bmsuser/addBmsUser.do"
                ...
                <ol>
                  ...
                  <li class="listyle_4">
                    ...
                    <span class="cmxformspan" style="width: 200px;">
                    	<domain:radioDomain domain="dataIsused" name="userStatus" uid="userStatus_" value="1" />
                ...
                <ol>
                  <li class="listyle_4 bordernone">
                    ...
                    <span class="cmxformspan" style="width: 200px;">
                      ...
                      女 -->
                      <domain:radioDomain domain="SEX" name="userSex" uid="userSex_" value="1" />
                      </span> </li>
                  <li class="listyle_4  bordernone">
	...
	<div id="deptDiv" style="display: none; text-align: center;">
		<iframe src="${pageContext.request.contextPath}/sys/bmscommon/selDept.do" width="100%" height="100%" frameborder="0" scrolling="auto"></iframe>
	</div>
