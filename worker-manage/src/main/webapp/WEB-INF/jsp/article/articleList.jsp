...
<script type="text/javascript">
			...
			{
				var url = "${pageContext.request.contextPath}/pub/article/beforeDelete.do";
				if(!$chk(id))
				{
			...
			{
				var url = "${pageContext.request.contextPath}/pub/article/beforeAdd.do";
...
<div id="workspace">
    ...
    <div id="container">    
        ...
        <div class="toolbar">
        	...
        	<a href="#" class="sexybutton" onclick="btn_add_click()"><span><span>新增文章</span></span></a> 
