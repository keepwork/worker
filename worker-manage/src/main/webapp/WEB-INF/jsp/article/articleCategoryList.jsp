...
<script type="text/javascript">
			...
			{
				var url = "${pageContext.request.contextPath}/pub/articleCate/beforeDelete.do";
				if(!$chk(id))
				{
			...
			{
				var url = "${pageContext.request.contextPath}/pub/articleCate/beforeAdd.do";
				document.location.href=url;
			}			
		</script>
<body class="overfwidth">

<div class="barnavtop">您所在的位置：文章管理 > 文章分类列表</div>
<div id="workspace">
	<!--主体 开始-->
    <div id="container">    
        <!--searchForm 开始-->
        ...
        <div class="eXtremeTable">
            <ec:table tableId="ArticleCategoryList" items="list" method="post" var="m" action=""
			...
			<ec:row>
				...
				<ec:column title="分类名称" property="name">
					<a href="${pageContext.request.contextPath}/pub/articleCate/beforeEdit.do?code=${m.code}">${m.name} </a>
				</ec:column>
				...
				<ec:column title="操作" property="EEE" sortable="false"
					...
					<a class="sexybutton" href="${pageContext.request.contextPath}/pub/articleCate/beforeEdit.do?code=${m.code}">
