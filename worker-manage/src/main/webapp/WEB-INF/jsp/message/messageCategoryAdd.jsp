...
<div id="mainDiv">
<div class="barnavtop">您所在的位置：消息管理 > 消息分类管理 > 新增消息分类</div>
	<!--主体 开始-->
    <div id="container">
    	<!--按钮 开始-->  
 <div class="toolbar">
		...
		<a href="#" class="sexybutton"  onClick="rbutton()"><span><span>重置 </span></span></a>
        	<a href="${pageContext.request.contextPath}/pub/messageCate/queryList.do" class="sexybutton" ><span><span>返回</span></span></a> 
               </div>
        <!--按钮 结束-->  
        <!--框内内容 开始-->
          <div class="editspace">
            <form name="frmApply" class="cmxform"
							action="${pageContext.request.contextPath}/pub/messageCate/add.do"
                ...
                <ol>
                  <li class="listyle_4">
                    ...
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <msg:message id="parentCode" value="" />
                    </span></h1>
                  </li>
                  <li class="listyle_4">
