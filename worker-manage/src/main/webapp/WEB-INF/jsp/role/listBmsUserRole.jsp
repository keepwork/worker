	...
	<script type="text/javascript">
			function btn_delete_click(id)
			{
				if(confirm("确认要删除该用户的角色授权么？")==true){
					var url = "${pageContext.request.contextPath}/sys/bmsrole/deleteRoleUsers.do";
					if(!$chk(id))
					{
			...
			{
				var url = "${pageContext.request.contextPath}/sys/bmsuserfunc/beforeDefineUserFunc.do";
			...
			{
				this.location.href="${pageContext.request.contextPath}/sys/bmsrole/listNotCheckedUsers.do?roleid=${roleid}";
			}
