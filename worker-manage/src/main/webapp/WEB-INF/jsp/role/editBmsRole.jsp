...
<div class="barnavtop">您所在的位置：系统管理 > 角色管理 > 编辑角色</div>
	...
	<form name="frmApply" class="cmxform"
			action="${pageContext.request.contextPath}/sys/bmsrole/editBmsRole.do"
    ...
    <div id="container">
        ...
        <!--框内内容 开始-->
      	...
      	<div class="toolbar mb10">
        	...
        	<a href="#" class="sexybutton" onclick="location.href='${pageContext.request.contextPath}/sys/bmsrole/queryBmsRole.do'"><span><span>返回</span></span></a> 
        </div>
		</div>
		<iframe width="100%" height="600px;" frameborder="0" src="${pageContext.request.contextPath}/sys/bmsrole/listRoleUsers.do?roleid=${m.id}" name="roleToUserFrame00" scrolling-y="yes"></iframe>
	</form>
</div>
</body>
</html>
        <div id="locationDiv" style="display: none; text-align: center;">
			...
			src="${pageContext.request.contextPath}/sys/bmscommon/selLocation.do"
