...
<div id="workspace">
  ...
  <div id="container"> 
    <div class="editspace">
     ...
     <form name="form1" action="${pageContext.request.contextPath}/sys/bmsrole/defineRscForBmsRole.do" method="post" target="hideframe">
 ...
 <div class="toolbar" style="text-align:center;">
        ...
        <a href="#" class="sexybutton" onclick="location.href='${pageContext.request.contextPath}${ATX_.context.backUrlStore}'"><span><span>返回
