...
<body class="overfwidth">
 ...
 <div class="toolbar">
        ...
        <a href="#" class="sexybutton" onclick="location.href='${pageContext.request.contextPath}/sys/bmsrole/listRoleUsers.do?roleid=${param.roleid}'">
        							<span><span>返回</span></span></a>        </div>
        <div id="searchForm" style="display:none">
        <form method="post" class="cmxform editspace" style="text-align: left; padding: 1px;"
        action="${pageContext.request.contextPath}/sys/bmsrole/saveOrUpdateRoleUsers.do" id="submitform">
