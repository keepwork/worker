...
<script type="text/javascript">
			...
			{
				var url = "${pageContext.request.contextPath}/sys/bmsrole/beforeDeleteBmsRole.do";
				if(!$chk(id))
				{
			...
			{
				var url = "${pageContext.request.contextPath}/sys/bmsrole/beforeAddBmsRole.do";
        ...
        <div class="eXtremeTable">
			...
			<ec:row>
				...
				<ec:column title="角色名称" property="name">
					<a
						href="${pageContext.request.contextPath}/sys/bmsrole/beforeEditBmsRole.do?id=${m.id}">
						${m.name} </a>
				</ec:column>
				...
				<ec:column title="操作" property="EEE" sortable="false"
					...
					<a class="sexybutton" href="${pageContext.request.contextPath}/sys/bmsrole/beforeEditBmsRole.do?id=${m.id}">
					...
					<logic:notEqual value="<%=superman%>" name="m" property="id">
						...
						<a class="sexybutton" href="${pageContext.request.contextPath}/sys/bmsrole/beforeDefineRscForBmsRole.do?id=${m.id}">
						<span><span>功能权限</span></span></a>
						<!-- 
						<a class="sexybutton" href="${pageContext.request.contextPath}/sys/bmsrole/beforeInDateRole.do?id=${m.id}">
