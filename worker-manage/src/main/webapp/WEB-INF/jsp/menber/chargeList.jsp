...
<div class="barnavtop">您所在的位置：会员管理 > 会员充值记录</div>
<div id="workspace">
	<!--主体 开始-->
    <div id="container">    
        <div class="toolbar">
        ...
        <div class="eXtremeTable">
            <ec:table tableId="ChargeList" items="list" method="post" var="m" action=""
			imagePath="${ctx}/images/table/*.gif"
			width="98%" rowsDisplayed="10" view="compact"
			filterRowsCallback="limit" sortRowsCallback="limit"
			retrieveRowsCallback="limit">
			<ec:row>
				<ec:column title="充值金额（元）" property="price"></ec:column>
				<ec:column title="充值时间" property="createTimeStr"></ec:column>
			</ec:row>
		</ec:table>
        </div>
        <div class="toolbar">
