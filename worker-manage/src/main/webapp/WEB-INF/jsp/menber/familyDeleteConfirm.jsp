...
<script type="text/javascript">
			...
			{
				hideframe.location.href="${pageContext.request.contextPath}/pub/family/delete.do";
			}		
		</script>
<body class="overfwidth">

<div class="barnavtop">您所在的位置：托管账户管理 > 删除托管账户</div>
<div id="workspace">
	<!--主体 开始-->
    <div id="container">    
        ...
        <div class="eXtremeTable">
			...
			<ec:row>
				<ec:column title="被托管账户姓名" property="realName"></ec:column>
			</ec:row>
		</ec:table>
        </div>
