...
<script type="text/javascript">
			...
			{
				hideframe.location.href="${pageContext.request.contextPath}/pub/menber/delete.do";
			}		
		</script>
<body class="overfwidth">

<div class="barnavtop">您所在的位置：会员管理 > 删除会员</div>
<div id="workspace">
	<!--主体 开始-->
    <div id="container">    
        ...
        <div class="eXtremeTable">
			...
			<ec:row>
				<ec:column title="登录名" property="loginName"></ec:column>
