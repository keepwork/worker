...
<div class="barnavtop">您所在的位置：会员管理 > 会员分享记录</div>
<div id="workspace">
	<!--主体 开始-->
    <div id="container">    
        <div class="toolbar">
        ...
        <div class="eXtremeTable">
            <ec:table tableId="ShareList" items="list" method="post" var="m" action=""
			imagePath="${ctx}/images/table/*.gif"
			width="98%" rowsDisplayed="10" view="compact"
			filterRowsCallback="limit" sortRowsCallback="limit"
			retrieveRowsCallback="limit">
			<ec:row>
				<ec:column title="已分享会员" property="realName"></ec:column>
				<ec:column title="已分享头像" property="headimgurl">
					<img src="${m.headimgurl}" style="width: 50px;height: 50px;"/>
				</ec:column>
				<ec:column title="分享时间" property="createTimeStr"></ec:column>
			</ec:row>
		</ec:table>
        </div>
        <div class="toolbar">
