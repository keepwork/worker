...
function showmain(){
	...
	$('#iframeBoxCont .ContIframe').hide();
	$('#iframeBoxCont .ContIframe').eq(0).show().attr('src','/sys/main/loadapp.do?id=4028825628d8fa7f0128d91ae1160016');
	

}
</script>
<!-- 
<script language="javascript" src="${pageContext.request.contextPath}/js/navtree/navtree.js"></script>
 -->
</head>
...
<div class="container">
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td width="173" id="leftTree" valign="top" style="border:2px solid #3b89d1;border-top:none;">
			...
			<td id="mainCont" class="mainBox" valign="top">
				<div class="mainBoxTitle">
					...
					<div class="closeAll"><img src="${pageContext.request.contextPath}/sys/public/images/manuClose.png" title="关闭全部" alt="关闭全部" /></div>
