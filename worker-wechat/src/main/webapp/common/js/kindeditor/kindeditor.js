			...
			var onloadFunc = function() {
				...
				if (typeof data === 'object' && 'error' in data) {
					if (data.error === '0') {
						...
						currentPicNum ++;
						var tmpxqpic = parent.document.getElementById('tmpxqpic').value;
						if(tmpxqpic != ""){
							tmpxqpic += "，";
						}
						tmpxqpic += data.picid;
						parent.document.getElementById('tmpxqpic').value = tmpxqpic;
					} else {
						alert(data.message);
						return false;
					}
